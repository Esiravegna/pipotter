...
def test_the_happy_path(effect_list, create_valid_config, tmpdir):
    ...
    assert f.spells['incendio'].queue[0].initialized_value[0] == 'this_must_be_the_first_value'
    assert f.spells['incendio'].queue[4].initialized_value[0] == 'this_must_be_the_last_value'
